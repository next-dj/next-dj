...
class TestFindAnchorParsing:
    """`find_anchor` locates anchors with the HTML parser, not a regex."""
    ...
    def test_multiple_anchors_on_one_line(self) -> None:
        html = '<a href="/x">one</a><a href="/y">two</a><a href="/z">three</a>'
        assert find_anchor(html, href="/z") == '<a href="/z">three</a>'
