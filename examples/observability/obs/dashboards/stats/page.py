...
# `render_chart` widget because page-level scripts land in the injection
# order before every widget's co-located file, so `component.js` always
# finds `window.Chart` defined.
